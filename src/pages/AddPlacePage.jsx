  ...
  return (
    <div className="min-h-screen bg-navy-950">
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <h1 className="text-2xl font-sora font-bold text-white mb-6">Add New Place</h1>
        <form onSubmit={handleSubmit} className="bg-white/5 border border-white/5 rounded-xl p-6 space-y-4">
